    ...
    methods: {
      ...
      workTypeName(){
        this.workType.forEach(item=>{
          if(this.form.copyrightType === item.dictId){
            // this.form.copyrightTypeName = item.dictName
            this.$set(this.form, 'copyrightTypeName', item.dictName);
            // console.log(this.form.copyrightTypeName ,"==this.form.copyrightTypeName =>")
          }
        })
      },
