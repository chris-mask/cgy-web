          ...
          <div class="item-detail">
            ...
            <div class="detail">
              ...
              <div class="user-conent">
                <div class="item">
                  <div class="cate">专利编号：<span>{{item.firstApplyName}}</span></div>
  ...
  export default {
    ...
    data() {
      return {
        ...
        // allowDetail: this.authorityControl('SYSTEM:CUSTOMER:MANAGE','SYSTEM:CUSTOMER:CENTER','SYSTEM:CUSTOMER:CENTER:PROPERTY:PATENT:DETAILS'),//
        allowDetail: true,// 查询专利详情
        allowDelete: this.authorityControl('SYSTEM:CUSTOMER:MANAGE','SYSTEM:CUSTOMER:CENTER','SYSTEM:CUSTOMER:CENTER:PROPERTY:PATENT:DELETE'),//删除专利
        allowGetList: this.authorityControl('SYSTEM:CUSTOMER:MANAGE','SYSTEM:CUSTOMER:CENTER','SYSTEM:CUSTOMER:CENTER:PROPERTY:PATENT:LIST'),//专利列表
        allowExport: this.authorityControl('SYSTEM:CUSTOMER:MANAGE','SYSTEM:CUSTOMER:CENTER','SYSTEM:CUSTOMER:CENTER:PROPERTY:PATENT:EXPORT'),//导出专利列表
      }
    },
    mounted() {
      this.getPatentData();
    ...
    methods: {
      ...
      getPatentData() {
        ...
        // console.log(this.companyNames,"===this.companyNames23==>")
      ...
      getList() {
        ...
        // console.log(this.companyNames,"===this.companyNames111==>")
        if (this.id !== undefined) {
        ...
        if(this.allowGetList.twoAllow){
          queryPatentList(this.listQuery).then(res => {
            if (res.code === 200) {
              ...
              if(this.id !== undefined){
                this.$emit('patentTotal',Number(res.data.total));
              }
            }
          })
        }else{
