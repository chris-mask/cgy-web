  ...
  export default {
    ...
    data() {
      return {
        ...
        allowAdd: this.authorityControl('SYSTEM:CUSTOMER:MANAGE','SYSTEM:CUSTOMER:CENTER','SYSTEM:CUSTOMER:CENTER:PROPERTY:Copyright:INSERT'),//新增著作权
        allowUpdate: this.authorityControl('SYSTEM:CUSTOMER:MANAGE','SYSTEM:CUSTOMER:CENTER','SYSTEM:CUSTOMER:CENTER:PROPERTY:Copyright:UPDATE'),//编辑著作权
        // allowDetail: this.authorityControl('SYSTEM:CUSTOMER:MANAGE','SYSTEM:CUSTOMER:CENTER','SYSTEM:CUSTOMER:CENTER:PROPERTY:Copyright:DETAILS'),//查询著作权详情
        allowDetail: true,
        allowDelete: this.authorityControl('SYSTEM:CUSTOMER:MANAGE','SYSTEM:CUSTOMER:CENTER','SYSTEM:CUSTOMER:CENTER:PROPERTY:Copyright:DELETE'),//删除著作权
        allowGetList: this.authorityControl('SYSTEM:CUSTOMER:MANAGE','SYSTEM:CUSTOMER:CENTER','SYSTEM:CUSTOMER:CENTER:PROPERTY:Copyright:LIST'),//著作权列表
        allowExport: this.authorityControl('SYSTEM:CUSTOMER:MANAGE','SYSTEM:CUSTOMER:CENTER','SYSTEM:CUSTOMER:CENTER:PROPERTY:Copyright:EXPORT'),//导出著作权列表
      }
    },
    mounted() {
        ...
        if(this.allowGetList.twoAllow){
          queryCopyrightList(this.listQuery).then(res => {
            if (res.code === 200) {
              ...
              if(this.id !== undefined){
                this.$emit('copyrightTotal',Number(res.data.total));
              }
            }
          })
        }else{
